 ...
 */
public class BasicDeviceDataInformation {
    ...
    public BasicDeviceDataInformation()
    {

    }

    public BasicDeviceDataInformation(String _sn, String _productName, String _aliasName, String _ipAddress, boolean _logined)
    {
        setSn(_sn);
